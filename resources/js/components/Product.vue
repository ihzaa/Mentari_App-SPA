  ...
  <div class="mx-5 my-3">
    <b-row class="justify-content-around" align-v="center">
      ...
      >
        ...
        <b-card-body>
          <b-card-text class="info" v-if="product.description.length < 180">
            {{ product.description }}
          </b-card-text>
        ...
        <b-card-footer class="card-footer" tag="footer">
          <b-button @click.stop="addToCart(product.item_id)" variant="success">
  ...
  methods: {
    ...
    loadProduct: async function () {
      try {
        ...
        this.productInfo.push.apply(this.productInfo, response.data.data);
