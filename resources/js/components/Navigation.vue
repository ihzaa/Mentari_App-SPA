...
<template>
  <div>
    <b-navbar
      ...
      variant="info"
    >
      <b-navbar-brand href="#" @click="test"
        ><h1><strong>Mentari</strong></h1></b-navbar-brand
      >
      ...
      <b-collapse id="nav-collapse" is-nav>
        <b-navbar-nav class="ml-auto mr-4">
          ...
          <b-nav-item-dropdown class="userNav" right v-if="!isUserEmpty">
            <template #button-content>
              <strong>User</strong>
            </template>
            <b-dropdown-item href="#">Profile</b-dropdown-item>
...
export default {
  ...
  methods: {
    test() {
      ...
      console.log(user);
      console.log(window._.isEmpty(user.data));
    },
    check: function () {
